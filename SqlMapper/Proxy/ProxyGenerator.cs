...
namespace Extensions.SqlMapper.Proxy
{
    public class ProxyGenerator
    {
        ...
        public static T GetInterfaceProxy<T>()
        {
            ...
            object k;
            if (TypeCache.TryGetValue(typeOfT, out k)) return (T)k;
            ...
            {
                var isId = property.GetCustomAttributes(true).Any(a => a is Attributes.KeyAttribute);
        ...
        private static void CreateProperty<T>(TypeBuilder typeBuilder, string propertyName, Type propType, MethodInfo setIsDirtyMethod, bool isIdentity)
        {
            ...
            if (isIdentity)
            {
                var keyAttribute = typeof(Attributes.KeyAttribute);
